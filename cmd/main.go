...
import (
	...
	"github.com/Tee2912/To-Do-List-Go/config"
	"github.com/Tee2912/To-Do-List-Go/db"
	"github.com/Tee2912/To-Do-List-Go/server"
...
func run(log *log.Logger) error {
	...
	// =========================================================================
	// Database support
	db, err := db.Connect(ctx, cfg.MongodbHostName, cfg.MongodbDatabase, cfg.MongodbPort)
	if err != nil {
